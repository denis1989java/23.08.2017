...
<nav class="navbar fixed-top navbar-toggleable-md navbar-light" id="mainNav">
    ...
    <div class="container">
        <a class="navbar-brand">Change book</a>
        <div class="collapse navbar-collapse" id="navbarExample">
            <ul class="navbar-nav ml-auto">
                <security:authorize access="hasAuthority('ADMIN')">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/admin/allOrders">Orders</a>
                    </li>
                    <li class="nav-item">
...
<header class="masthead">
    <div class="header-content">
        <div class="main-login main-center">
            <div class="col-md-5">
                <form:form method="post" modelAttribute="book" action="/admin/updateBook" >
                    <div class="form-inline">
                        <form:input path="bookId" type="hidden" name="bookId" id="bookId"/>
