        ...
        <div class="row">
            <div class="col-md-6" style="text-align: center">
                <table>
                    ...
                    <tr>
                        <td style="color: #FFFFFF"><c:out value="${orderDTO.orderId}"/></td>
                        <td style="color: #FFFFFF"><c:out value="${orderDTO.orderPrice}"/></td>
                        <td style="color: #FFFFFF"><c:out value="${orderDTO.orderDate}"/></td>
                    </tr>
                    ...
                    <c:otherwise>
                        ...
                        <form action="/user/order/deleteBook?orderId=${orderDTO.orderId}" method="post">
                            <table>
                                ...
                                <c:forEach var="ordersBooksDTO" items="${OrderBookTimesDTO}" varStatus="status">
                                    <tr>
