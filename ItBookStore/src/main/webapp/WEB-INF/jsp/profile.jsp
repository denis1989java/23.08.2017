                    ...
                    <div class="col-md-26" style="float: left">
                        <table>
                            <tr>
                                ...
                                <td style="color: #FFFFFF"><c:out value="${userInformationDTO.userName}"/></td>
                            </tr>
                            <tr>
                                <td style="color: #FFFFFF"><c:out value="Surname"/></td>
                                <td style="color: #FFFFFF"><c:out value="${userInformationDTO.userSurname}"/></td>
                            </tr>
                            <tr>
                                <td style="color: #FFFFFF"><c:out value="Second Name"/></td>
                                <td style="color: #FFFFFF"><c:out value="${userInformationDTO.userSecondName}"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="color: #FFFFFF"><c:out value="${userInformationDTO.userPhoneNumber}"/></td>
                            </tr>
                            <tr>
                                <td style="color: #FFFFFF"><c:out value="Address"/></td>
                                <td style="color: #FFFFFF"><c:out value="${userInformationDTO.userAddress}"/></td>
                            </tr>
                            <tr>
                                <td style="color: #FFFFFF"><c:out value="Additional Info"/></td>
                                <td style="color: #FFFFFF"><c:out
                                        value="${userInformationDTO.userAdditionalInfo}"/></td>
                            </tr>
