...
<nav class="navbar fixed-top navbar-toggleable-md navbar-light" id="mainNav">
    ...
    <div class="container">
        <a class="navbar-brand" href="#page-top">Book Store</a>
        <div class="collapse navbar-collapse" id="navbarExample">
            <ul class="navbar-nav ml-auto">
                ...
                <a style="color: #e13612"><c:out value="${successMessage}"></c:out></a>
                <security:authorize
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 text-center">
                    ...
                    <hr class="primary">
                    <p>Contact us a call or send us an email if you have any problems with registration or ordering! We
                        will help you so fast, so it possible! Thanks for choosing us!</p>
                </div>
                <div class="container text-center">
                    <a style="background-color: #e13612;" class="btn btn-default btn-xl sr-button" href="/contact/form">Write to
                        us!</a>
                </div>
            </div>
        </div>
